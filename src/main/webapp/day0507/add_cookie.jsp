...
String age=request.getParameter("age");//input type="text" name="age"
String chk=request.getParameter("saveFlag");//input type="checkbox" name="saveFlag"
out.print(chk);//checked 되지 않으면 null, value 속성이 없는 상태에서 checked되면 "on"
