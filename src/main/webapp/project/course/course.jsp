...
<head>
  ...
  <!-- Swiper CSS -->
  <!-- <link rel="stylesheet" type="text/css" href="http://192.168.10.73/jsp_prj/project/css/layout.css" />
  <link rel="stylesheet" type="text/css" href="http://192.168.10.73/jsp_prj/project/css/common.css" /> -->
  <!-- <link rel="stylesheet" type="text/css" href="http://192.168.10.73/jsp_prj/project/css/course_style.css" /> -->
  <link rel="stylesheet" type="text/css" href="http://localhost/jsp_prj/project/course/css/course_style.css" />
  ...
  <main>
    ...
    <div class="container">
        <div class="sidebar">
            ...
            <nav class="sub-nav">
                <ul>
                    <li><a href="http://localhost/jsp_prj/project/course/course_rule.jsp" >관람규칙</a></li>
                    <li><a href="http://localhost/jsp_prj/project/course/course_time.jsp">관람시간</a></li>
                    <li><a href="http://localhost/jsp_prj/project/course/course.jsp" class="active">관람코스</a></li>
		...
		<div class="tab_con current">
					<div class="course_tab_wrap">
						<div class="course_pop">
							<div class="div_st"><img src="course_img/ic_loca.jpg" alt="위치"/>코스안내
							            <select class="sel_st">
							...
							<div class="tab_con map_info current">
								...
								<div class="course_map" style="overflow: hidden; user-select: none; touch-action: none;">
									<div class="zoomable" id="zoomable" style="cursor: move; user-select: none; touch-action: none; transform-origin: 50% 50%; transition: none; transform: scale(1) translate(0px, 0px);">
										<img data-id="1" class="map_content" src="/afile/previewThumbnail/23101048063hheEg" alt="전체 맵" draggable="true">
									</div>
								</div>
							</div>
						</div>
...
<div class="tab_con_wrap course_slide_wrap">
		<div class="tab_con cm1 current" data-tab="cm1">
				...
				<div class="course_slide swiper-initialized swiper-horizontal swiper-backface-hidden course_slide0">
					<div class="swiper-wrapper" id="swiper-wrapper-5fd736519f4a740b" aria-live="polite">
						<div class="swiper-slide swiper-slide-active swiper-slide-next" data-seq="8" role="group" aria-label="1 / 1" data-swiper-slide-index="0" style="width: 1010px;">
...
<div></div></div>
		...
		<div class="tab_con cm2" data-tab="cm2">
				...
				<div class="course_slide swiper-initialized swiper-horizontal course_slide1">
					<div class="swiper-wrapper" id="swiper-wrapper-dc05dd102d24dd655" aria-live="polite" style="transition-duration: 0ms; transition-delay: 0ms;">
...
<div style="text-align: justify;"></div></div>
		...
		<div class="tab_con cm3" data-tab="cm3">
				...
				<div class="course_slide swiper-initialized swiper-horizontal course_slide2">
					<div class="swiper-wrapper" id="swiper-wrapper-21cd7104e48703aca" aria-live="polite" style="transition-duration: 0ms; transition-delay: 0ms;">
						<div class="swiper-slide" data-seq="8" data-swiper-slide-index="0" role="group" aria-label="1 / 1">
								<img src="/afile/preview/4801" data-key="4801" alt="근정전 전경">
							</div>
						</div>
		...
		<div class="tab_con cm4" data-tab="cm4">
				...
				<div class="course_slide swiper-initialized swiper-horizontal course_slide3">
					<div class="swiper-wrapper" id="swiper-wrapper-50719c8d3a7e4a7c" aria-live="polite" style="transition-duration: 0ms; transition-delay: 0ms;">
						<div class="swiper-slide" data-seq="8" data-swiper-slide-index="0" role="group" aria-label="1 / 1">
								<img src="/afile/preview/4801" data-key="4801" alt="근정전 전경">
							</div>
						</div>
...
<div style="text-align: justify;"></div></div>
		...
		<div class="tab_con cm5" data-tab="cm5">
				...
				<div class="course_slide swiper-initialized swiper-horizontal course_slide4">
					<div class="swiper-wrapper" id="swiper-wrapper-399b24dd88d3ce710" aria-live="polite" style="transition-duration: 0ms; transition-delay: 0ms;">
						<div class="swiper-slide" data-seq="8" data-swiper-slide-index="0" role="group" aria-label="1 / 1">
								<img src="/afile/preview/4801" data-key="4801" alt="근정전 전경">
							</div>
						</div>
...
<div style="text-align: justify;"></div></div>
		...
		<div class="tab_con cm6" data-tab="cm6">
				...
				<div class="course_slide swiper-initialized swiper-horizontal course_slide5">
					<div class="swiper-wrapper" id="swiper-wrapper-ef36656fc7a68375" aria-live="polite" style="transition-duration: 0ms; transition-delay: 0ms;">
						<div class="swiper-slide" data-seq="8" data-swiper-slide-index="0" role="group" aria-label="1 / 1">
								<img src="/afile/preview/4801" data-key="4801" alt="근정전 전경">
							</div>
						</div>
...
<div style="text-align: justify;"></div></div>
		...
		<div class="tab_con cm7" data-tab="cm7">
				...
				<div class="course_slide swiper-initialized swiper-horizontal course_slide6">
					<div class="swiper-wrapper" id="swiper-wrapper-b34100591c1b85a7a" aria-live="polite" style="transition-duration: 0ms; transition-delay: 0ms;">
						<div class="swiper-slide" data-seq="8" data-swiper-slide-index="0" role="group" aria-label="1 / 1">
								<img src="/afile/preview/4801" data-key="4801" alt="근정전 전경">
							</div>
						</div>
...
<div style="text-align: justify;"></div></div>
		...
		<div class="tab_con cm8" data-tab="cm8">
				...
				<div class="course_slide swiper-initialized swiper-horizontal course_slide7">
					<div class="swiper-wrapper" id="swiper-wrapper-3bab677d101691ec5" aria-live="polite" style="transition-duration: 0ms; transition-delay: 0ms;">
						<div class="swiper-slide" data-seq="8" data-swiper-slide-index="0" role="group" aria-label="1 / 1">
								<img src="/afile/preview/4801" data-key="4801" alt="근정전 전경">
							</div>
						</div>
		...
		<div class="tab_con cm9" data-tab="cm9">
				...
				<div class="course_slide swiper-initialized swiper-horizontal course_slide8">
					<div class="swiper-wrapper" id="swiper-wrapper-ff915e1109e4c744b" aria-live="polite" style="transition-duration: 0ms; transition-delay: 0ms;">
						<div class="swiper-slide" data-seq="8" data-swiper-slide-index="0" role="group" aria-label="1 / 1">
								<img src="/afile/preview/4801" data-key="4801" alt="근정전 전경">
							</div>
						</div>
...
<div></div></div>
		...
		<div class="tab_con cm10" data-tab="cm10">
				...
				<div class="course_slide swiper-initialized swiper-horizontal course_slide9">
					<div class="swiper-wrapper" id="swiper-wrapper-d588b95bc931a9e5" aria-live="polite" style="transition-duration: 0ms; transition-delay: 0ms;">
						<div class="swiper-slide" data-seq="8" data-swiper-slide-index="0" role="group" aria-label="1 / 1">
								<img src="/afile/preview/4801" data-key="4801" alt="근정전 전경">
							</div>
						</div>
		...
		<div class="tab_con cm11" data-tab="cm11">
				...
				<div class="course_slide swiper-initialized swiper-horizontal course_slide10">
					<div class="swiper-wrapper" id="swiper-wrapper-4a943f426f937558" aria-live="polite" style="transition-duration: 0ms; transition-delay: 0ms;">
						<div class="swiper-slide" data-seq="8" data-swiper-slide-index="0" role="group" aria-label="1 / 1">
								<img src="/afile/preview/4801" data-key="4801" alt="근정전 전경">
							</div>
						</div>
...
<div style="text-align: justify;"></div></div>
		...
		<div class="tab_con cm12" data-tab="cm12">
				...
				<div class="course_slide swiper-initialized swiper-horizontal course_slide11">
					<div class="swiper-wrapper" id="swiper-wrapper-e5452ae9c2d810ffc" aria-live="polite" style="transition-duration: 0ms; transition-delay: 0ms;">
						<div class="swiper-slide" data-seq="8" data-swiper-slide-index="0" role="group" aria-label="1 / 1">
								<img src="/afile/preview/4801" data-key="4801" alt="근정전 전경">
							</div>
						</div>
		...
		<div class="tab_con cm13" data-tab="cm13">
				...
				<div class="course_slide swiper-initialized swiper-horizontal course_slide12">
					<div class="swiper-wrapper" id="swiper-wrapper-a58885cc3d77cd35" aria-live="polite" style="transition-duration: 0ms; transition-delay: 0ms;">
						<div class="swiper-slide" data-seq="8" data-swiper-slide-index="0" role="group" aria-label="1 / 1">
								<img src="/afile/preview/4801" data-key="4801" alt="근정전 전경">
							</div>
						</div>
		...
		<div class="tab_con cm14" data-tab="cm14">
				...
				<div class="course_slide swiper-initialized swiper-horizontal course_slide13">
					<div class="swiper-wrapper" id="swiper-wrapper-d0374b53ddac27b3" aria-live="polite" style="transition-duration: 0ms; transition-delay: 0ms;">
						<div class="swiper-slide" data-seq="8" data-swiper-slide-index="0" role="group" aria-label="1 / 1">
								<img src="/afile/preview/4801" data-key="4801" alt="근정전 전경">
							</div>
						</div>
