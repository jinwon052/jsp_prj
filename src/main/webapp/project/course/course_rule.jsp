...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="http://localhost/jsp_prj/project/course/css/course_rule_style.css" />
  <!-- <link rel="stylesheet" type="text/css" href="http://192.168.10.73/jsp_prj/project/css/course_rule_style.css" /> -->
  ...
  <main>
    ...
    <div class="container">
        <div class="sidebar">
            ...
            <nav class="sub-nav">
                <ul>
                    <li><a href="http://localhost/jsp_prj/project/course/course_rule.jsp" class="active">관람규칙</a></li>
                    <li><a href="http://localhost/jsp_prj/project/course/course_time.jsp">관람시간</a></li>
                    <li><a href="http://localhost/jsp_prj/project/course/course.jsp">관람코스</a></li>
            ...
            <div class="sub_con_section">
                 <div class="box_wrap ">
                      <div class="txt_wrap">
                       ...
                       <img src="http://localhost/jsp_prj/project/course/course_rule_img/course_rule.jpg" alt="관람규칙 아이콘">
                 </div>
             </div>
