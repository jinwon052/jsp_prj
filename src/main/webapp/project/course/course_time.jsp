...
<head>
  ...
  <!-- <link rel="stylesheet" type="text/css" href="http://localhost/jsp_prj/project/course/css/course_time_style.css" /> -->
  <link rel="stylesheet" type="text/css" href="http://localhost/jsp_prj/project/course/css/course_time_style.css" />
        ...
        <div class="sidebar">
            ...
            <nav class="sub-nav">
                <ul>
                    ...
                    <li><a href="http://localhost/jsp_prj/project/course/course_time.jsp" class="active">관람시간</a></li>
            ...
            <section>
                ...
                <div class="holiday-section">
                    <div class="holiday-card">
                        <img src="http://localhost/jsp_prj/project/course/course_time_img/mon.png" alt="월요일" class="img_wrap">
                        <strong>월요일</strong>
                        <p>창덕궁, 덕수궁, 창경궁, 경희궁</p>
                    </div>
                    <div class="holiday-card">
                        <img src="http://localhost/jsp_prj/project/course/course_time_img/tue.png" alt="화요일" class="img_wrap">
                        <strong>화요일</strong>
                        <p>경복궁</p>
                    </div>
                    <br>
