...
삼항: ${ i % 2 == 0 ?"짝수인가?":'홀수입니다.' } (${ i mod 2 eq 0 ?"짝수":'홀수' })
<br>
<!-- scope 객체가 가지고 있는 i 값이 0~10 사이라면 "유효" 그렇지 않으면 "무효" 웹 브라우저에 출력-->
${ i >= 0 && i < 11 ?"유효":"무효" } (${ i gt -1 and i le 10 ?"유효":"무효" })<Br>
