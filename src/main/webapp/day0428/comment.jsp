...
String name="이장훈";
%>
<!-- HTML주석: JSP > java > class > instance 생성 > HTML로 만들어진다. -->
HTML 주석: <!-- <%= name %> --><br>
<!-- Java주석: JSP > java > class에 포함되지 않음 > instance 생성X > HTML로 만들어지지 않음 -->
Java 주석: <%= /*이것은 이름변수 임*/ name %> <br>
<!-- JSP주석: JSP > java에 포함 되지 않음 > class에 포함되지 않음 > instance 생성X > HTML로 만들어지지 않음 -->
JSP 주석: <%-- <%= name %> --%>
</div>
</main>
