...
<style type="text/css">
 ...
 .calTab > thead > tr > th { width: 120px; height: 30px; border : 1px solid #CECECE; text-align: center;} 
...
<div id="calendarWrap">
	...
	flagDate.append(cal.get(Calendar.YEAR)).append(cal.get(Calendar.MONTH)+1);
	...
	if(paramYear != null){//입력되는 년,월을 사용하여 다른 날짜로 설정
		cal.set(Calendar.DAY_OF_MONTH,1);// 모든 월에 있는 날짜로 설정되어야 날짜 이동
...
%>
	...
	<span title="오늘" class="btnToDay">	<a href="javascript:moveCalendar('t',<%=flagYear%>,<%=flagMonth%>)">오늘</a></span>
	</div>
