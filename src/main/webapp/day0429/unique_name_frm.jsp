...
<form name="frmGet" id="frmGet" action="../day0430/unique_name_process.jsp" method="get">
...
<form name="frmPost" id="frmPost" action="../day0430/unique_name_process.jsp" method="post">
