...
$(function() {
	...
	$('#summernote').summernote({
		 placeholder: '자유롭게 자신의 생각을 작성해보세요.',
	     tabsize: 2,
	     height: 240,
	     toolbar: [
	         ['style', ['style']],
	...
	$("#btnModify").click(function(){
		setEdit("m");
		//obj.method="get";//form의 요청방식 변경 가능
...
<th colspan="2" style="text-align: center">
	...
	<td><input type="text" name="subject" id="subject"
		value="${ bDTO.subject }"
	 style="width:520px; height: 30px; border: 1px solid #CDCDCD;"></td>
	</tr>
	<tr>
	<td>내용</td>
	<td>
	...
	<tr>
	<td>조회수</td>
	<td><strong><c:out value="${ bDTO.cnt }"></c:out></strong>
	</tr>
	<tr>
	<td>작성자 ID(IP)</td>
	...
	<tr>
	<td>작성일</td>
	<td><strong><fmt:formatDate value="${ bDTO.input_date }"
		pattern="yyyy-MM-dd a HH:mm"/></strong>
	</td>
	</tr>
	<tr>
	...
	%>
	<a href="board_list.jsp?currentPage=${param.currentPage }${search}" class="btn btn-info btn-sm">글 목록</a>
	</td>
	</tr>
</table>
</form>
