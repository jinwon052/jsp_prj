...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"
    info="useBean action 태그로 web parameter 한 번에 받기"%>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
...
<!-- 체크박스가 하나인 경우 checked 되면 value가 checked되지 않았다면 null --> 
...
<li><label>checkbox 여러 개</label>: 
<jsp:getProperty property="lang" name="param"/></li>
