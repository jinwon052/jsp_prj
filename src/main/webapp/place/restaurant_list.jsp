...
<tr>
<td colspan="5" style="text-align: center;">등록된 맛집이 없습니다. <br>
<img src="../login/images/login_fail.jpg" style="width: 60px">
<br>
<a href="write_rest_frm.jsp">맛집 등록하기</a>
</td>
</tr>
</c:if>
<%
...
<td><a href ="rest_detail.jsp?rest_num=${ restDTO.rest_num }&currentPage=${ rDTO.currentPage }${ queryStr }"><c:out value="${ restDTO.restaurant }"/></a></td>
...
PaginationDTO pDTO=new PaginationDTO(3, rDTO.getCurrentPage(),
		totalPage,"restaurant_list.jsp",rDTO.getField(),rDTO.getKeyword());
%>
