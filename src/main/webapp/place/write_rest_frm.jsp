...
$(function() {
	...
	$("#btnAdd").click(function(){
		...
		if( confirm("식당 정보를 입력하시려면 로그인 하셔야 합니다.\n로그인 하시겠습니까?")){
...
<tr>
<td>식당명</td>
<td><input type="text" name="restaurant" style="width: 500px;" id="restaurant"></td>
</tr>
<tr>
<td>대표메뉴</td>
...
<td><input type="button" value="식당정보추가" id="btnAdd" class="btn btn-success"/>
